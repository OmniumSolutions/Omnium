        ...
        <div className="lg:col-span-12 p-6 sm:p-12 lg:p-20 flex flex-col justify-center items-center text-center relative z-10">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-lg mx-auto">
              Seja no Delivery, ou na Industria, na nuvem ou na recepção: Nossas arquiteturas são desenhadas para durar.
            </motion.p>
      ...
      <section id="about" className="py-24 px-4 sm:px-8 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="relative z-10 w-full -mx-4 sm:-mx-8">
              <style>{`
                .hide-scrollbar::-webkit-scrollbar { display: none; }
              `}</style>
              <div 
                className="flex overflow-x-auto gap-6 pb-8 pt-4 px-6 sm:px-12 snap-x snap-mandatory items-start hide-scrollbar" 
                style={{ 
                  scrollbarWidth: 'none', 
              ...
              <div className="bg-white border border-slate-200 p-8 rounded-3xl shadow-xl shadow-slate-200/50 shrink-0 w-[320px] sm:w-[400px] snap-center flex flex-col justify-between">
